...
export default function KitchenPage() {
  ...
  const allProducts = homewareProducts.filter(p => p.category === 'Homeware').slice(6, 40);
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-[300px] md:h-[400px] w-full">
        <Image
          src="/images/product-kitchen.jpg"
          alt="Kitchen & Dining"
          fill
        ...
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">Kitchen & Dining</h1>
            <p className="text-lg md:text-xl max-w-2xl mx-auto px-4">
              Elegant pieces for dining and entertaining
            </p>
          </div>
        </div>
      </div>
