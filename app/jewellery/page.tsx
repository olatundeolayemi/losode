...
import { jewelryProducts } from '@/lib/products';
...
export default function JewelleryPage() {
  ...
  const allProducts = jewelryProducts;
      ...
      <div className="relative h-[300px] md:h-[400px] w-full">
        ...
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">Jewellery</h1>
            <p className="text-lg md:text-xl max-w-2xl mx-auto px-4">
              Exquisite pieces of African craftsmanship
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="sticky top-32 space-y-6">
              <div>
                ...
                <div className="space-y-2">
                  {['All', 'Necklaces', 'Bracelets', 'Earrings', 'Rings', 'Sets'].map((cat) => (
