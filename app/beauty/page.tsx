...
export default function BeautyPage() {
  ...
  const beautyProducts = accessoriesProducts.slice(0, 40);
  const designers = ['All', ...new Set(beautyProducts.map((p) => p.designer))];
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-[300px] md:h-[400px] w-full overflow-hidden bg-gradient-to-b from-gray-50 to-white">
        <Image
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center px-4">
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4" style={{ color: '#1A1A1A' }}>Beauty</h1>
            <p className="text-gray-700 text-base md:text-lg max-w-2xl mx-auto">
              Discover luxury skincare, cosmetics, and beauty essentials for your self-care routine
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="sticky top-32 space-y-6">
              <div>
                ...
                <div className="space-y-2">
                  {['All', 'Skincare', 'Makeup', 'Hair Care', 'Body Care'].map((cat) => (
              ...
              <button
                onClick={() => setSelectedFilters({ category: 'All', designer: 'All' })}
