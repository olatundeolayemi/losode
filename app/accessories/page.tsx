...
export default function AccessoriesPage() {
  ...
  const allAccessoriesProducts = accessoriesProducts;
  const filteredProducts = allAccessoriesProducts.slice(0, displayCount);
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-64 md:h-96 w-full overflow-hidden bg-gradient-to-b from-gray-100 to-white">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4">
          <h1 className="text-4xl md:text-5xl font-serif mb-4" style={{ color: '#1A1A1A' }}>Accessories</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-8">
        ...
        {sortedProducts.length < allAccessoriesProducts.length && (
