...
import { shoesProducts } from '@/lib/products';
...
export default function KidsShoesPage() {
  ...
  const allProducts = shoesProducts.slice(0, 40);
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-[300px] md:h-[400px] w-full">
        <Image
          src="/images/kids-shoes-colorful-1.jpg"
          alt="Kids' Shoes"
          fill
        ...
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">Kids' Shoes</h1>
            <p className="text-lg md:text-xl max-w-2xl mx-auto px-4">
              Comfortable shoes for active kids
            </p>
          </div>
        </div>
      </div>
