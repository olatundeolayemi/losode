...
import { kidsProducts, womenClothingProducts, womenShoesProducts, accessoriesProducts } from '@/lib/products';
import { clothingProducts } from '@/lib/clothingProducts'; // Declare clothingProducts
import { shoesProducts } from '@/lib/shoesProducts'; // Declare shoesProducts
...
export default function KidsPage() {
  ...
  // Combine all kids products
  const allKidsProducts = kidsProducts;

  const categories = [
    { name: 'New In', href: '/kids/new-in', image: '/images/shopby-casual-wear.jpg' },
    { name: 'Clothing', href: '/kids/clothing', image: '/images/product-dresses-1.jpg' },
    { name: 'Shoes', href: '/kids/shoes', image: '/images/product-shoes-2.jpg' },
    { name: 'Accessories', href: '/kids/accessories', image: '/images/product-accessories-showcase.jpg' },
  ];

  const designers = ['All', ...new Set(allKidsProducts.map((p) => p.designer))];

  // Filter and sort products
  let filteredProducts = [...allKidsProducts];
      ...
      <div className="relative h-[300px] md:h-[400px] w-full">
        ...
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">Kids</h1>
            <p className="text-lg md:text-xl max-w-2xl mx-auto px-4">
              Colorful African fashion for the little ones
            </p>
          </div>
        </div>
      </div>
          ...
          <div className={`${showFilters ? 'block' : 'hidden'} md:block w-64 flex-shrink-0`}>
            <div className="sticky top-32 space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {['All', 'Under ₦20,000', '₦20,000 - ₦40,000', '₦40,000 - ₦70,000', 'Above ₦70,000'].map((price) => (
