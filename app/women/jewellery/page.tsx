...
export default function WomenJewelleryPage() {
  const [sortBy, setSortBy] = useState('newest');
  const [showFilters, setShowFilters] = useState(false);

  const allProducts = accessoriesProducts.filter(p => p.gender === 'women' || p.category === 'Jewellery').slice(0, 50);
      ...
      <div className="relative h-[300px] md:h-[400px] w-full">
        ...
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">Women's Jewellery</h1>
