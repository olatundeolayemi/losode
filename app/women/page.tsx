...
import { womenClothingProducts, womenShoesProducts, bagsProducts, jewelryProducts, accessoriesProducts } from '@/lib/products';
...
export default function WomenPage() {
  ...
  const allWomenProducts = [
    ...
    ...womenShoesProducts,
    ...bagsProducts.filter(p => p.gender === 'women'),
    ...jewelryProducts.filter(p => p.gender === 'women'),
    ...accessoriesProducts.filter(p => p.gender === 'women'),
  ];

  const categories = [
    { name: 'New In', href: '/women/new-in', image: '/images/product-dresses-1.jpg' },
    { name: 'Clothing', href: '/women/clothing', image: '/images/product-dresses-2.jpg' },
    { name: 'Shoes', href: '/women/shoes', image: '/images/product-shoes-1.jpg' },
    { name: 'Bags', href: '/women/bags', image: '/images/product-bags-1.jpg' },
    { name: 'Jewellery', href: '/women/jewellery', image: '/images/category-jewellery-hero.jpg' },
    { name: 'Accessories', href: '/women/accessories', image: '/images/product-accessories-showcase.jpg' },
  ];

  const designers = ['All', ...new Set(allWomenProducts.map((p) => p.designer))];

  // Filter and sort products
  let filteredProducts = [...allWomenProducts];
      ...
      <div className="relative h-[300px] md:h-[400px] w-full">
        ...
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">Women</h1>
            <p className="text-lg md:text-xl max-w-2xl mx-auto px-4">
              Discover our stunning collection of African-inspired fashion for women
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="sticky top-32 space-y-6">
              ...
              <div>
                ...
                <div className="space-y-2">
                  {['All', 'Clothing', 'Shoes', 'Bags', 'Jewellery', 'Accessories'].map((cat) => (
