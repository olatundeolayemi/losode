  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-[300px] md:h-[400px] w-full">
        <Image
          src="/images/men-dress-shirt-1.jpg"
          alt="Men's Clothing"
          fill
        ...
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">Men's Clothing</h1>
            <p className="text-lg md:text-xl max-w-2xl mx-auto px-4">
              Discover our premium men's clothing collection
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="sticky top-32 space-y-6">
              <div>
                ...
                <div className="space-y-2">
                  {['All', 'Shirts', 'Tops', 'Boubous', 'Jumpsuits', 'Kaftans'].map((cat) => (
