...
export default function MenShoesPage() {
  ...
  const allProducts = shoesProducts;
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="relative h-[300px] md:h-[400px] w-full">
        <Image
          src="/images/men-shoes-formal-1.jpg"
          alt="Men's Shoes"
          fill
        ...
        <div className="absolute inset-0 bg-black/30 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-4xl md:text-5xl font-serif font-bold mb-4">Men's Shoes</h1>
            <p className="text-lg md:text-xl max-w-2xl mx-auto px-4">
              Step into style with our men's shoe collection
            </p>
          </div>
        </div>
      </div>
